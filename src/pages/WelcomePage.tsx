    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-between px-6 py-10 max-w-lg mx-auto w-full animate-in fade-in duration-700">
      ...
      <div className="w-full space-y-6">
        <div className="text-center">
          ...
          <p className="text-muted-foreground text-sm mt-1">Your Safety, Our Priority</p>
        </div>
        ...
        <div className="flex justify-center gap-6">
          <div className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">SOS</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center">
              <MapPin className="w-5 h-5 text-primary" />
            </div>
            <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Tracking</span>
          </div>
          <div className="flex flex-col items-center gap-1.5">
            ...
            <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Protection</span>
          </div>
        </div>
        ...
        <p className="text-center text-[11px] text-muted-foreground">Protected by ResQHer Security</p>
      </div>
    </div>
  );
}
