-- 1. Create a log table to capture any hidden database errors
...
-- 2. Safely remove any NOT NULL constraints that might be causing the crash
DO $$ BEGIN
...
-- Ensure protector has address column
ALTER TABLE public.protector ADD COLUMN IF NOT EXISTS address TEXT;

-- 3. Replace Trigger with EXCEPTION handling so registration NEVER FAILS
